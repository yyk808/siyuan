...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/sync/setThirdPartyInbox", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, setThirdPartyInbox)
	ginServer.Handle("POST", "/api/sync/testThirdPartyInbox", model.CheckAuth, model.CheckAdminRole, testThirdPartyInbox)
